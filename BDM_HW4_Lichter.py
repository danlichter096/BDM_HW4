...
def main(sc):
  ...
  joindf.where(F.col('naics_code').isin([445120])).drop('naics_code')\
  ...
  joindf.where(F.col('naics_code').isin([722410])).drop('naics_code')\
              .groupby('year','date').agg(F.stddev_pop('visits').alias('std'), F.sort_array(F.collect_list('visits')).alias('array_visits'))\
              .withColumn('middle', F.ceil(F.size(F.col('array_visits'))/2).cast('int'))\
              .withColumn('std', F.round('std').cast('int'))\
              .withColumn('median', F.col('array_visits')[F.col('middle')-F.lit(1)])\
  ...
  joindf.where(F.col('naics_code').isin([722511])).drop('naics_code')\
              .groupby('year','date').agg(F.stddev_pop('visits').alias('std'), F.sort_array(F.collect_list('visits')).alias('array_visits'))\
              .withColumn('middle', F.ceil(F.size(F.col('array_visits'))/2).cast('int'))\
              .withColumn('std', F.round('std').cast('int'))\
              .withColumn('median', F.col('array_visits')[F.col('middle')-F.lit(1)])\
  ...
  joindf.where(F.col('naics_code').isin([722513])).drop('naics_code')\
              .groupby('year','date').agg(F.stddev_pop('visits').alias('std'), F.sort_array(F.collect_list('visits')).alias('array_visits'))\
              .withColumn('middle', F.ceil(F.size(F.col('array_visits'))/2).cast('int'))\
              .withColumn('std', F.round('std').cast('int'))\
              .withColumn('median', F.col('array_visits')[F.col('middle')-F.lit(1)])\
  ...
  joindf.where(F.col('naics_code').isin([446110,446191])).drop('naics_code')\
              .groupby('year','date').agg(F.stddev_pop('visits').alias('std'), F.sort_array(F.collect_list('visits')).alias('array_visits'))\
              .withColumn('middle', F.ceil(F.size(F.col('array_visits'))/2).cast('int'))\
              .withColumn('std', F.round('std').cast('int'))\
              .withColumn('median', F.col('array_visits')[F.col('middle')-F.lit(1)])\
  ...
  joindf.where(F.col('naics_code').isin([311811,722515])).drop('naics_code')\
              .groupby('year','date').agg(F.stddev_pop('visits').alias('std'), F.sort_array(F.collect_list('visits')).alias('array_visits'))\
              .withColumn('middle', F.ceil(F.size(F.col('array_visits'))/2).cast('int'))\
              .withColumn('std', F.round('std').cast('int'))\
              .withColumn('median', F.col('array_visits')[F.col('middle')-F.lit(1)])\
  ...
  joindf.where(F.col('naics_code').isin([445210,445220,445230,445291,445292,445299])).drop('naics_code')\
              .groupby('year','date').agg(F.stddev_pop('visits').alias('std'), F.sort_array(F.collect_list('visits')).alias('array_visits'))\
              .withColumn('middle', F.ceil(F.size(F.col('array_visits'))/2).cast('int'))\
              .withColumn('std', F.round('std').cast('int'))\
              .withColumn('median', F.col('array_visits')[F.col('middle')-F.lit(1)])\
  ...
  joindf.where(F.col('naics_code').isin([445110])).drop('naics_code')\
              .groupby('year','date').agg(F.stddev_pop('visits').alias('std'), F.sort_array(F.collect_list('visits')).alias('array_visits'))\
              .withColumn('middle', F.ceil(F.size(F.col('array_visits'))/2).cast('int'))\
              .withColumn('std', F.round('std').cast('int'))\
              .withColumn('median', F.col('array_visits')[F.col('middle')-F.lit(1)])\
